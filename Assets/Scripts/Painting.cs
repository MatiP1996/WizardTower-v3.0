...
public class Painting : MonoBehaviour
{
    ...
    CharacterController controlScript;
    Transform camPos;
    ...
    void Start()
    {
        ...
        controlScript = player.GetComponent<CharacterController>();
    ...
    void LeavePainting()
    {
        ...
        player.GetComponent<CharacterController>().inputAllowed = true;
    ...
    void Update()
    {
        ...
        {
            //controlScript.movementAllowed = true;
        }
    }
}
